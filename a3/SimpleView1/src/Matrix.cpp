...
void Matrix::normalize() {
	// add code here
	GLfloat len = sqrt(mat[0][0]*mat[0][0] + mat[1][0]*mat[1][0] + mat[2][0]*mat[2][0]); //euclid len
	mat[0][0] = mat[0][0]/len;
	mat[1][0] = mat[1][0]/len;
	mat[2][0] = mat[2][0]/len;

	mat[0][2] = mat[1][0]*mat[2][1]-mat[2][0]*mat[1][1];//cross product
	mat[1][2] = mat[2][0]*mat[0][1]-mat[0][0]*mat[2][1];//corss product
	mat[2][2] = mat[0][0]*mat[1][1]-mat[1][0]*mat[0][1];//cross product

	len = sqrt(mat[0][2]*mat[0][2] + mat[1][2]*mat[1][2] + mat[2][2]*mat[2][2]); //euclid len
	mat[0][2] = mat[0][2]/len;
	mat[1][2] = mat[1][2]/len;
	mat[2][2] = mat[2][2]/len;

	mat[0][1] = mat[1][2]*mat[2][0]-mat[1][0]*mat[2][2]; // cross product
	mat[1][1] = mat[2][2]*mat[0][0]-mat[2][0]*mat[0][2]; // cross product
	mat[2][1] = mat[0][2]*mat[1][0]-mat[0][0]*mat[1][2]; // cross product

	mat[3][0] = 0; //reset homogeneous scaling
	mat[3][1] = 0;
	mat[3][2] = 0;
	mat[3][3] = 1;
}
